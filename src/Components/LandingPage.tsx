            ...
            <div id="landpage">
                ...
                <div>
                    ...
                    <p>David is studying Computer Engineering at Polytechnique Montreal and subscribed to Hackavillage a
                        ...
                        While
                        he gains points and rewards like rebate on its monthly pass for doing so, he helps the city
                        solve
                        its traffic and CO2 problems. On the other side, BIXI Montreal can see the abstract data
                        converted
                        into charts and graph to help see the progress towards its goal. This data can be projected to
                        help
